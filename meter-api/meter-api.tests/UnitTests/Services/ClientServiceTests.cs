...
public class ClientServiceTests
{
    ...
    {
        return args != null && args.Length != 0 && args[0] is ClientUpdateMessage message && message.Body is MeterSnapshot snapshot && snapshot.MeterId == meterId &&
    ...
    {
        // Arrange
        var sut = CreateSut(out var snapshotService, out var _, out var clients, out var clientProxy);
        var meterId = "meter-1";
